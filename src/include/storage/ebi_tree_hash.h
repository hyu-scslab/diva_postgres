...
#define EbiTreeMappingPartitionLock(hashcode)        \
  (&MainLWLockArray[EBI_TREE_MAPPING_LWLOCK_OFFSET + EbiTreeHashPartition(hashcode)].lock)
...
extern int EbiTreeHashInsert(const EbiTreeBufTag* tagPtr, uint32 hashcode, int page_id);
